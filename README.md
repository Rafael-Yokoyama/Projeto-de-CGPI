...
<table>
       ...
       <b> --- Aranha ---</b>
      <p>
        <img src="./result_works/seg01.png" width="600px;" alt="Foto "/><br>
        <sub>
...
<table>
       ...
       <b>--- Trevo ---</b>
      <p>
        <img src="./result_works/seg02.png" width="600px;" alt="Foto "/><br>
        <sub>
          <p> <b>Processo de segmentação da primeira imagem</b>(A) Imagem Original (B) Ground Truth obtido do banco de imagem (C) Ground Truth gerado e (D) Imagem Segmentada</p>
        </sub>
      </p>
...
<table>
       ...
       <b>--- Ovo ---</b>
      <p>
        <img src="./result_works/seg03.png" width="600px;" alt="Foto "/><br>
        <sub>
          <p> <b>Processo de segmentação da primeira imagem</b>(A) Imagem Original (B) Ground Truth obtido do banco de imagem (C) Ground Truth gerado e (D) Imagem Segmentada</p>
        </sub>
      </p>
...
<table>
       ...
       <b>--- Flamingo ---</b>
      <p>
        <img src="./result_works/seg04.png" width="600px;" alt="Foto "/><br>
        <sub>
          <p> <b>Processo de segmentação da primeira imagem</b>(A) Imagem Original (B) Ground Truth obtido do banco de imagem (C) Ground Truth gerado e (D) Imagem Segmentada</p>
        </sub>
      </p>
...
<table>
     ...
     <b> --- Maça ---</b>
      <p>
        <img src="./result_works/seg05.png" width="600px;" alt="Foto "/><br>
        <sub>
          <p> <b>Processo de segmentação da primeira imagem</b>(A) Imagem Original (B) Ground Truth obtido do banco de imagem (C) Ground Truth gerado e (D) Imagem Segmentada</p>
        </sub>
      </p>
